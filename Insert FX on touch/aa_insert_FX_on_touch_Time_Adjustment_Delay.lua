...
local scr_title = 'aa_insert_FX_on_touch_Time_Adjustment_Delay.lua'
...
-- parse line
  ...
  function main(tr)
	...
	local fxId = TrackFX_AddByName( tr, "time_adjustment_cockos", false, 0 )
	--reaper.ShowConsoleMsg( fxId )
	if fxId < 0 then
		fxId = TrackFX_AddByName( tr, "time_adjustment_cockos", false, -1 )
