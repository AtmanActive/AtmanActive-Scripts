...
local scr_title = 'aa_insert_FX_on_touch_dd_dualfilter.lua'
...
-- parse line
  ...
  function main(tr)
	...
	local fxId = TrackFX_AddByName( tr, "VST2:DD DualFilter (Dead Duck Software)", false, 0 )
	--reaper.ShowConsoleMsg( fxId )
	if fxId < 0 then
		fxId = TrackFX_AddByName( tr, "VST2:DD DualFilter (Dead Duck Software)", false, -1 )
