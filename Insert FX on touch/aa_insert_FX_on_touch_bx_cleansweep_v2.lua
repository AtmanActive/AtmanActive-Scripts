...
local scr_title = 'aa_insert_FX_on_touch_bx_cleansweep_v2.lua'
...
-- parse line
  ...
  function main(tr)
	...
	local fxId = TrackFX_AddByName( tr, "VST2:bx_cleansweep V2 (Brainworx)", false, 0 )
	--reaper.ShowConsoleMsg( fxId )
	if fxId < 0 then
		fxId = TrackFX_AddByName( tr, "VST2:bx_cleansweep V2 (Brainworx)", false, -1 )
