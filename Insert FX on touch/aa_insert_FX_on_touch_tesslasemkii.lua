...
local scr_title = 'aa_insert_FX_on_touch_tesslasemkii.lua'
...
-- parse line
  ...
  function main(tr)
	...
	local fxId = TrackFX_AddByName( tr, "VST2:TesslaSEmkII (Variety Of Sound)", false, 0 )
	--reaper.ShowConsoleMsg( fxId )
	if fxId < 0 then
		fxId = TrackFX_AddByName( tr, "VST2:TesslaSEmkII (Variety Of Sound)", false, -1 )
